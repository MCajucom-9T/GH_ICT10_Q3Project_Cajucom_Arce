...
def intrams_team(e):
    ...
    register = float(document.getElementById('register').value) # collecting value from an input field
    clearance = float(document.getElementById('clearance').value)
    grade = float(document.getElementById('lvl').value)
    section = float(document.getElementById('sec').value) 
